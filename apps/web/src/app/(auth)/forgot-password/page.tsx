  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4 md:p-12 overflow-x-hidden"
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4"
            style={{ backgroundColor: "#002045", boxShadow: "0 4px 12px rgba(0,32,69,0.25)" }}>
            <span className="material-symbols-outlined text-white text-3xl"
              style={{ fontVariationSettings: "'FILL' 1" }}>
              shield_with_heart
            </span>
          </div>
          <h1 className="text-2xl font-bold text-[#002045] mb-1"
            style={{ fontFamily: "Atkinson Hyperlegible Next, sans-serif" }}>
            AppMiSalud Familia
          </h1>
          <p className="text-xs font-semibold text-[#43474e] tracking-widest uppercase">
        ...
        <div className="bg-white rounded-2xl p-8 relative overflow-hidden"
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-[#002045] mb-2 leading-tight"
              style={{ fontFamily: "Atkinson Hyperlegible Next, sans-serif" }}>
          ...
          {!sent ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label htmlFor="email" className="text-xs font-semibold text-[#002045] block tracking-wide">
                  Correo electrónico
                </label>
                <div className="relative group">
                  <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[#74777f] text-[20px] transition-colors group-focus-within:text-[#13696a]">
                    mail
                  </span>
                  <input
                    id="email"
                    ...
                    required
                    className="w-full pl-11 pr-4 py-3 border border-[#c4c6cf] rounded-xl outline-none transition-all focus:ring-2 focus:ring-[#13696a] focus:border-[#13696a] text-sm"
              ...
              <button
                ...
                style={{ backgroundColor: "#002045", boxShadow: "0 2px 8px rgba(0,32,69,0.2)" }}
              >
                {loading ? (
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl flex items-start gap-3"
                ...
                <span className="material-symbols-outlined text-[#13696a] shrink-0">check_circle</span>
                <p className="text-xs font-medium text-[#1a6d6e] leading-relaxed">
              ...
              <p className="text-xs text-center text-[#74777f]">
                ...
                <button onClick={() => setSent(false)}
                  className="text-[#13696a] font-semibold hover:underline">
                  Intentar de nuevo
                </button>
              </p>
            </div>
        ...
        <div className="mt-6 flex flex-col items-center gap-3">
          <Link href="/login"
            className="inline-flex items-center gap-1 text-sm font-semibold text-[#13696a] hover:underline transition-all">
      ...
      <div className="fixed bottom-6 right-6 hidden md:flex items-center gap-2 px-4 py-2 rounded-full border pointer-events-none"
        ...
        <span className="text-xs font-semibold text-[#002045]">Privacidad protegida por AppMiSalud</span>
      </div>
    </main>
  );
}
